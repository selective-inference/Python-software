...
class selective_sampler_MH_randomX_boot(selective_sampler):
    ...
    def next(self):
        ...
        opt_vars = self.penalty.step_variables(self.state, self.randomization, self.logpdf, self.cur_grad, SigmaTinv,  hessian, _XTX_b)
