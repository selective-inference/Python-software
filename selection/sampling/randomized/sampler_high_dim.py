...
class selective_sampler_MH_high_dim(selective_sampler):
    ...
    def next(self):
        ...
        data, opt_vars = self.penalty.step_variables(self.state, self.randomization, self.logpdf, gradient, hessian, X)
