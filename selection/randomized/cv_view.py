...
class CV_view(query):
    ...
    def __init__(self, loss, scale1=1, scale2=1, K=5):
    ...
    def solve(self):
        ...
        (self.lam_CVR,
         ...
         self.observed_score_state) = (lam_CVR,
                                       CVR_val,
                                       CV1_val)
        lam_idx = list(self.lam_seq).index(self.lam_CVR) # index of the minimizer
        self._solved = True
    ...
    def projection(self, opt_state):
        return opt_state #-self.projection_map(-opt_state)
